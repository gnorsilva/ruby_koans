...
class AboutMethods < EdgeCase::Koan
  ...
  def test_private_and_protected_method_calls
    assert_equal B.new.the_private, "priv in AboutMethods::B"
    assert_equal B.new.the_protected, "prot in AboutMethods::B"
  end
end
