...
class AboutIteration < EdgeCase::Koan
  ...
  #  it applies the operation to the first item where the initial sum is the value passed into inject, eg: 0
  #  then passes the result of this as the next 'sum'. It 'reduces' the array values into one value
  end
