...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_shortcut_character_classes_are_negated_with_capitals
    ...
    #The greedy operator only catches the first non word
    assert_equal " = ", "variable_1 = 42 = 40 + 2"[/\W+/]
    assert_equal " ", "a variable_1 = 42"[/\W+/]
  end
  ...
  def test_sub_is_like_find_and_replace
    ...
    assert_equal "one two-three", "one two-three".sub(/(t\w*)/) { $1[0, 5] }
  end
